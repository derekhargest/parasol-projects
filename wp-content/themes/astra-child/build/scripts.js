...
jQuery(document).ready(function($) {
	...
	var dots = $('.home-carousel--nested .owl-dots').css('position', 'absolute').css('bottom', '5px');
dots.css('left', 'calc(50% - ' + dots.width()/2+'px)');
  ...
  return $(".modal").on("show.bs.modal", function() {
	...
	$('.home-carousel--nested .owl-dot').hover(function() { 
$(this).click(); 
}, 
function() {} 
); 
...
for (let button of Buttons) {
 ...
 function accordionDirectory() {
        ...
        jQuery(".searchandfilter h4").wrap("<a class='filter-accordion-title' href='#'></a>");jQuery(".searchandfilter h4").after("<span class='counter'></span>");
        ...
        jQuery('.sf-field-post-meta-location a, .sf-field-post-meta-city a, .sf-field-taxonomy-pop-up-tag a, .sf-field-post-meta-neighborhoods a, .sf-field-post-meta-type_of_event a').click(function () {
